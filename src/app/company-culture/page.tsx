      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto shadow-xl rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Find companies that align with your values and work style.
              This feature is currently under development.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              Soon, you'll be able to find companies that match your values and work style by
              analyzing employer reviews and job satisfaction ratings.
            </p>
