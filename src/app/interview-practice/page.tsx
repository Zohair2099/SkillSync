      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto shadow-xl rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Hone your interview skills with our AI-powered practice tool. 
              This feature is currently under development.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              Soon, you'll be able to choose a job role, get realistic interview questions,
              and receive feedback on your responses.
            </p>
