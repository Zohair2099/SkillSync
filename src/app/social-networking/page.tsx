      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto shadow-xl rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Connect with professionals and join the community.
              This feature is currently under development.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              Soon, you'll be able to connect with mentors, recruiters, and professionals via LinkedIn
              and join a community forum to discuss job search tips and experiences.
            </p>
